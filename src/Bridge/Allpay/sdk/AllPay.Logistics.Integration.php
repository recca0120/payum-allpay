...
class AllpayLogistics
{
    ...
    public function CreateShippingOrder($ButtonDesc = '物流訂單建立', $Target = '_self')
    {
        ...
        } elseif ($this->PostParams['LogisticsSubType'] == LogisticsSubType::UNIMART_C2C) {
    ...
    protected function ValidateStoreType()
    {
        ...
        } elseif ($this->PostParams['StoreType'] != StoreType::RECIVE_STORE and $this->PostParams['StoreType'] != StoreType::RETURN_STORE) {
    ...
    protected function ValidateLogisticsType()
    {
        ...
        } elseif ($this->PostParams['LogisticsType'] != LogisticsType::CVS and $this->PostParams['LogisticsType'] != LogisticsType::HOME) {
    ...
    protected function ValidateIsCollection($AllowEmpty = false)
    {
        ...
        } elseif ($this->PostParams['LogisticsType'] == LogisticsType::HOME and $this->PostParams['IsCollection'] == IsCollection::YES) {
    ...
    protected function ValidateMerchantTradeDate()
    {
        ...
        } elseif (date('Y/m/d H:i:s', strtotime($this->PostParams['MerchantTradeDate'])) != $this->PostParams['MerchantTradeDate']) {
    ...
    protected function NextLine($content)
    {
        return $content."\n";
    }

    protected function GenPostHTML($ButtonDesc = '', $Target = '_self')
    {
        // 產生 POST form HTML
    ...
    protected function GenCheckMacValue($ParamList, $HashKey, $HashIV)
    {
        // CheckMacValue
        uksort($ParamList, ['AllpayLogistics', 'MerchantSort']);
    ...
    protected function ServerPost($ParamList, $URL)
    {
        $Curl = curl_init();
    ...
    protected static function MerchantSort($val_01, $val_02)
    {
        return strcasecmp($val_01, $val_02);
    }

    protected function ParseFeedback($Feedback, $FeedbackList = ['RtnCode', 'RtnMsg'], $Separator = '|')
    {
        $Pieces = explode('|', $Feedback);
        $Feedback = [];
